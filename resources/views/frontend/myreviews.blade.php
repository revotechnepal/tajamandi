        ...
        <div class="container">
            ...
            @endif
                                ...
                                @foreach ($reviews as $review)
                                                    ...
                                                    <div class="co-item">
                                                        {{-- <p>Review of project <a href="{{route('projectinfo', $currentproduct->id)}}" style="text-decoration: none">{{$currentproduct->title}}</a></p> --}}
                                                        <h5 style="color: #b83955; margin-bottom:1rem;">Review of product <a href="{{route('products', $currentproduct->slug)}}" class="hoverColor">{{$currentproduct->title}}</a>
                                                            {{-- <a href="#" class="btn btn-success btn-sm ml-4">&nbsp; Edit &nbsp;</a> --}}
                                                            <button type="button" class="btn btn-success btn-sm ml-4" data-toggle="modal" data-target="#editreviewModal{{$currentproduct->id . Auth::user()->id}}">&nbsp; Edit &nbsp;</button>
                                                            <!-- Modal -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3 text-center">
                                                                <div class="avatar-pic">
                                                                    <img src="{{Storage::disk('uploads')->url($currentimage->filename)}}" alt="" style="max-width: 150px">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-9">
                                                                <div class="avatar-pic">
